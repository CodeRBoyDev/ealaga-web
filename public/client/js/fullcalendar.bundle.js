...
var FullCalendar = function (e) {
    ...
    var Ni = function () {
        ...
        return e.prototype.resetOptions = function (e, t) {
            ...
            for (var f = li(o.eventSources, e, p, c), h = gi(o.eventStore, e, f, p, c), v = ui(f) && !u.options.progressiveEventRendering && o.renderableEventStore || h, g = this.buildViewUiProps(c), m = g.eventUiSingleBase, y = g.selectionConfig, E = this.buildEventUiBySource(f), b = {
                ...
                }, S = r(r({}, c), b), w = 0, D = s.pluginHooks.reducers; w < D.length; w++) {
                var T = D[w];
                r(b, T(o, e, S))
            }
            var x = Vi(o, c),
            ...
            var e, t, n, o, i, a, s, l, u, c = this.props,
                ...
                y = f.calendarOptions;
            if (m && m !== y)
                for (var E in m.timeZone !== y.timeZone && (d.eventSources = v.eventSources = (a = v.eventSources, s = d.dateProfile, l = v, u = s ? s.activeRange : null, pi(a, hi(a, l), u, !0, l)), d.eventStore = v.eventStore = (e = v.eventStore, t = p.dateEnv, n = v.dateEnv, o = e.defs, i = St(e.instances, (function (e) {
                        var i = o[e.defId];
    ...
    var Fs = function (e) {
        function t(n) {
            ...
            o.subjectEl = null, o.subjectSeg = null, o.isDragging = !1, o.eventRange = null, o.relevantEvents = null, o.receivingContext = null, o.validMutation = null, o.mutatedRelevantEvents = null, o.handlePointerDown = function (e) {
                ...
                o.relevantEvents = Sn(l.getCurrentData().eventStore, c), i.minDistance = e.isTouch ? 0 : s.eventDragMinDistance, i.delay = e.isTouch && c !== r.props.eventSelection ? function (e) {
                    var t = e.context.options,
    ...
    function fl(e, t, n, r, o, i, a) {
        ...
        for (var p = s.addSegs(l), f = function (e, t, n) {
            ...
            for (var S = x.firstCol; S <= x.lastCol; S += 1) h[S].push({
                seg: hl(x, S, S + 1, a),
                isVisible: !1,
                isAbsolute: !1,
                absoluteTop: 0,
        ...
        for (var w = 0, D = p; w < D.length; w++) {
            ...
            for (S = C.start; S < C.end; S += 1) m[S] += 1, h[S].push({
                seg: hl(x, S, S + 1, a),
                isVisible: !1,
                isAbsolute: !1,
                absoluteTop: 0,
                ...
                if (c)
                    for (var h = 0, v = t; h < v.length; h++) {
                        var g = v[h],
                            ...
                            w = "",
                            D = "";
                        S && (l.isRtl ? (D = 0, w = c.lefts[m.lastCol] - c.lefts[m.firstCol]) : (w = 0, D = c.rights[m.firstCol] - c.rights[m.lastCol])), f.push(Co("div", {
        ...
        Xl = function (e) {
            ...
            return n(t, e), t.prototype.render = function () {
                ...
                var a = this,
                    ...
                    b = E.segPlacements,
                    S = E.hiddenGroups;
                return Co(_o, null, this.renderHiddenGroups(S, e), b.map((function (e) {
                    var s = e.seg,
                        l = e.rect,
    ...
    return _i.push($s, Tl, lu, yu, bu, wu, Tu), e.BASE_OPTION_DEFAULTS = cn, e.BASE_OPTION_REFINERS = un, e.BaseComponent = Uo, e.BgEvent = ds, e.BootstrapTheme = Eu, e.Calendar = Ds, e.CalendarApi = Rr, e.CalendarContent = fa, e.CalendarDataManager = Ni, e.CalendarDataProvider = ji, e.CalendarRoot = ga, e.Component = xo, e.ContentHook = Xo, e.CustomContentRenderContext = Zo, e.DateComponent = Fo, e.DateEnv = Lr, e.DateProfileGenerator = ai, e.DayCellContent = ss, e.DayCellRoot = us, e.DayGridView = Sl, e.DayHeader = xa, e.DaySeriesModel = ka, e.DayTable = bl, e.DayTableModel = Ra, e.DayTableSlicer = El, e.DayTimeCols = nu, e.DayTimeColsSlicer = tu, e.DayTimeColsView = au, e.DelayedRunner = Mi, e.Draggable = Zs, e.ElementDragging = oa, e.ElementScrollController = wo, e.Emitter = Eo, e.EventApi = _r, e.EventRoot = ns, e.EventSourceApi = ye, e.FeaturefulElementDragging = As, e.Fragment = _o, e.Interaction = ea, e.ListView = hu, e.MoreLinkRoot = ms, e.MountHook = $o, e.NamedTimeZoneImpl = Gi, e.NowIndicatorRoot = is, e.NowTimer = Da, e.PointerDragging = ks, e.PositionCache = bo, e.RefMap = Va, e.RenderHook = Yo, e.ScrollController = So, e.ScrollResponder = Ho, e.Scroller = za, e.SegHierarchy = qi, e.SimpleScrollGrid = ts, e.Slicer = _a, e.Splitter = to, e.StandardEvent = rs, e.Table = ml, e.TableDateCell = ba, e.TableDowCell = wa, e.TableView = Js, e.Theme = To, e.ThirdPartyDraggable = Ks, e.TimeCols = Ql, e.TimeColsSlatsCoords = Nl, e.TimeColsView = Il, e.ViewApi = Dr, e.ViewContextType = Ao, e.ViewRoot = ti, e.WeekNumberRoot = fs, e.WindowScrollController = Do, e.addDays = tt, e.addDurations = At, e.addMs = nt, e.addWeeks = et, e.allowContextMenu = Be, e.allowSelection = Ve, e.applyMutationToEventStore = br, e.applyStyle = Te, e.applyStyleProp = xe, e.asCleanDays = function (e) {
        ...
        return n
    }, e.buildIsoString = Vt, e.buildNavLinkAttrs = so, e.buildSegCompareObj = nr, e.buildSegTimeText = ar, e.buildSlatMetas = iu, e.buildTimeColsModel = su, e.collectFromHash = Rt, e.combineEventUis = _n, e.compareByFieldSpec = qe, e.compareByFieldSpecs = Ge, e.compareNumbers = Ke, e.compareObjs = Ct, e.computeEarliestSegStart = bs, e.computeEdges = ho, e.computeFallbackHeaderFormat = ma, e.computeHeightAndMargins = function (e) {
        ...
        return r
    }, e.findElements = we, e.flexibleCompare = Ye, e.flushSync = Po, e.formatDate = function (e, t) {
        void 0 === t && (t = {});
        var n = jr(t),
            r = ln(t),
        ...
        return n
    }, e.render = ko, e.renderChunkContent = Ga, e.renderFill = cs, e.renderMicroColGroup = Ya, e.renderScrollShim = Ja, e.requestJson = Ci, e.sanitizeShrinkWidth = Za, e.setElSeg = $n, e.setRef = Vo, e.sliceEventStore = Xn, e.sliceEvents = function (e, t) {
