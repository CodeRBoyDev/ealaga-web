                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-600px">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body   mx-5 mx-xl-15 my-7">
                                                        <!--begin::Form-->
                                                        <form id="modal_edit_service_form" class="form"
                                                            action="#" enctype="multipart/form-data">
                                                            @csrf
                                                            <!--begin::Scroll-->
                                                            <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                                 ...
                                                                 <div class="fv-row mb-7 text-center">
                                                                    ...
                                                                    <div class="image-input image-input-outline"
                                                                        ...
                                                                        <label
                                                                            ...
                                                                            <i class="bi bi-pencil-fill fs-7"></i>
                                                                            <!--begin::Inputs-->
                                                                            <input type="file" id="edit_icon" name="edit_icon"
                                                                                accept=".png, .jpg, .jpeg" />
                                                                            {{-- <input type="hidden"
                                                                                name="avatar_remove" /> --}}
                                                                            <!--end::Inputs-->
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <textarea name="edit_description" id="edit_description" placeholder="description..." class="form-control form-control-solid mb-3 mb-lg-0" rows="5" cols="50"></textarea>
                                                                    <!--end::Input-->
                                                                    <div class="validation-message"></div>
