					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="container-xxl" id="kt_content_container">
							...
							<div class="row g-5 g-xl-8">
								...
								<div class="col-xl-4">
									<!--begin::Misc Widget 1-->
									<div class="row mb-10 mb-xl-10 g-10 g-xl-10">
										<div class="col-6">
											<div class="card card-stretch">
												<a id="add_schedule_link" href="#" class="btn custom_card btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-danger bg-body flex-column justfiy-content-center align-items-center text-center w-100 p-10">
													<!--begin::Svg Icon | path: icons/duotune/ecommerce/ecm002.svg-->
													
														<img alt="Logo" src="/client/media/custom_icon/appointments.png" class="h-50px" />

													<!--end::Svg Icon-->
													<span class="fs-4 fw-bolder">Add Schedule</span>
												</a>
											</div>
										</div>
										<div class="col-6">
											<div class="card card-stretch">
												<a id="list_schedule_link" href="#" class="btn custom_card btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-danger bg-body flex-column justfiy-content-center align-items-center text-center w-100 p-10">
													<!--begin::Svg Icon | path: icons/duotune/technology/teh008.svg-->
													<img alt="Logo" src="/client/media/custom_icon/massage.png" class="h-50px" />
													...
													<!--end::Svg Icon-->
													<span class="fs-4 fw-bolder">Schedule</span>
												</a>
											</div>
										</div>
										<div class="col-6">
										...
										<div class="col-6">
											<div class="card card-stretch">
												<a id="volunteer_link" href="#" class="btn custom_card btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-danger bg-body flex-column justfiy-content-center align-items-center text-center w-100 p-10">
													...
													<!--end::Svg Icon-->
													<span class="fs-4 fw-bolder">Volunteer</span>
												</a>
											</div>
										</div>
